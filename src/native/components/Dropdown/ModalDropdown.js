...
export default class ModalDropdown extends Component {
    ...
    _renderDropdown() {
        const {scrollEnabled, renderSeparator, options, showsVerticalScrollIndicator, keyboardShouldPersistTaps} = this.props;
        return (
    ...
    _renderItem = ({item: rowData, index: rowID}) => {
        ...
        const preservedProps = {
            key,
            accessible,
            onPress: () => this._onRowPress(rowData, null, rowID, null),
        };
